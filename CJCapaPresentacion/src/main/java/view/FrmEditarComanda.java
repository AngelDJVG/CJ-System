 ...
 */
public class FrmEditarComanda extends javax.swing.JFrame {
    ...
    public FrmEditarComanda(int tipoComanda,Comanda comanda) {
        ...
        actualizarPanelFormulario(tipoComanda);
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Editar comanda - Pedido");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        controlAplicacion.actualizarComanda(cbxTipo.getSelectedIndex(),comanda.getId());
        this.dispose();
    ...
    public void actualizarPanelFormulario(int tipoComanda) {
        ...
        switch (tipoComanda) {
            case TiposComanda.PEDIDO -> {
                ComandaPedido comandaPedido = (ComandaPedido) comanda;
                lblTitulo.setText("Edicion de comanda - Pedido");
                ...
                txtNombreCliente.setText(  comandaPedido.getNombreCliente());
                ...
                txtDireccion.setText(comandaPedido.getDireccion());
            ...
            case TiposComanda.MESA -> {
                ComandaMesa comandaMesa = (ComandaMesa) comanda;
                lblTitulo.setText("Edicion de comanda - Mesa");
                ...
                cbxMesa.addItem(comandaMesa.getMesa());
                cbxMesa.setSelectedItem(comandaMesa.getMesa());
